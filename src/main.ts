...
async function bootstrap() {
  ...
  const config = new DocumentBuilder()
    ...
    .setDescription('Esta API implementa endpoints de autenticação e authorização com JWT, para as operações que envolvem a listagem de usuários, adição, edição e exclusão, o usuário precisa estar autenticado com um token válido.')
    .setVersion('1.0')
